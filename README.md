...
To optimize the italoTimefy application for production, run:
...
[Doing API-First development]: https://www.jhipster.tech/documentation-archive/v5.4.0/doing-api-first-development/
